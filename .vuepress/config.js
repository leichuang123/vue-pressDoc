...
module.exports = {
    ...
    themeConfig: {
        ...
        // 在导航最右边显示github链接
        repo: 'https://github.com/vuejs/vuepress/blob/master/packages/docs/docs/.vuepress/config.js',
        // 编辑此页功能打开
        editLinks: true,
        // 启用最后更新时间
        ...
        sidebar: {
            ...
            '/doc/html/': ['001-HTML5特性说明', '002-HTML字符实体'],
            ...
            '/doc/node/': ['001-express-api总结', '002-node中require引用缓存解决', '003-CommonJS规范'],
